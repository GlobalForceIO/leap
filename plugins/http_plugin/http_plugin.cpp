...
namespace eosio {
   ...
   api_category to_category(std::string_view name) {
      ...
      if (name == "subst_api") return api_category::subst_api;
   ...
   const char* from_category(api_category category) {
      ...
      if (category == api_category::subst_api) return "subst_api";
   ...
   std::string category_plugin_name(api_category category) {
      if (category == api_category::subst_api)
         return "eosio::subst_api_plugin";
